...
<nav class="navbar navbar-expand-lg container-fluid" id="header">
    <div id="mySidebar" class="sidebar">
        <div id="changingMenu">
            ...
            <hr>
            <div class="nav-item" style="margin-top:8px;">
                <a class="nav-link headerOption" style="padding-right:200px;margin-bottom:8px;" href="../student/browse.php">BROWSE</a>
            </div>
            <hr>
            <div class="nav-item" style="margin-top:8px;">
                <a class="nav-link headerOption" style="padding-right:200px;margin-bottom:8px;" href="../student/your-cv.php">YOUR CV</a>
            </div>
            <hr>
        </div>
        <?php 
            ...
            <div class="col-4" style="padding-left:10px;padding-top:6px;">
                ...
                <div class="navbar-collapse collapse order-1 order-lg-0" style="margin-top:7px;">
                    <ul class="navbar-nav" style="padding-left:0px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link headerOption" href="../student/browse.php">BROWSE</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link headerOption" href="../student/your-cv.php">YOUR CV</a>
                        </li>
                    </ul>
                </div>
            </div>
